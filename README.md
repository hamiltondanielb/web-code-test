...
While it is recommended that you develop this solution using React, you may choose a different Javascript framework, such as Angular or Ember. However, please bear in mind that we'd still like to see a fully working SPA solution. Therefore, your framework should have components for client-side routing, HTTP communication and DOM manipulation.
